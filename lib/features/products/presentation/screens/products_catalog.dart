...
import 'package:ecommerce/core/widgets/main_view.dart';
...
class ProductsCatalog extends ConsumerWidget {
    ...
    return SizedBox(
      ...
      child: categoriesAsync.when(
        ...
        data: (categories) {
          ...
          return _buildProductCategories(allCategories, ref, selectedCategory, screenWidth);
        },
      ),
    );
  }
  ...
  Widget _buildProductCategories(
    ...
    return ListView.separated(
      ...
      separatorBuilder: (context, index) => SizedBox(width: isLargeScreen ? 16 : 12),
      itemBuilder: (context, index) {
        ...
        return FilterChip(
          label: Text(
            ...
            style: TextStyle(
              fontSize: fontSize,
              color: isSelected ? Colors.white : AtomicSystemColorsFoundation.colorButtonPrimary,
  ...
  Widget _buildProducts(AsyncValue<List<Product>> productsAsync, double screenWidth) {
    return productsAsync.when(
      ...
      error: (error, stack) => Center(
        child: Column(
          ...
          children: [
            Icon(Icons.error_outline, color: Colors.red, size: screenWidth > 600 ? 56 : 48),
  ...
  double _calculateAspectRatio(double screenWidth) {
    if (screenWidth > 1800) return 0.65; // Más compacto en pantallas muy grandes
